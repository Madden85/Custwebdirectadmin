window.NUMO_DIRECT_CONFIG = {
  API_URL: "https://script.google.com/macros/s/AKfycbwqqBJ1A9tqYhPhEJe37Ik3-HGKZOHUUHqdf_jtLJuTv8tqQpt6WqX5jUBQwKPMbM92tw/exec",
  ...
  BUNDLES: [
    {
      ...
      text: "Sesuai untuk customer yang nak movie dan YouTube tanpa iklan.",
      price: "Tanya Admin"
    },
    {
      tag: "FAMILY",
      title: "Disney+ Hotstar + Sooka",
      text: "Untuk hiburan family, live sports dan movie pilihan.",
      price: "Tanya Admin"
    },
    {
      tag: "JIMAT",
      title: "Custom Bundle",
      text: "Pilih sendiri platform yang customer nak. Admin akan quote harga.",
      price: "Custom"
    }
  ],
...
window.NUMO_BUTTON_TEXT = {
  ...
  buyNow: "Order Sekarang",
  preparingOrder: "Prepare order...",
